...
public class Menu extends Fragment {
    ...
    Button makenote,openmap,openexplored;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        makenote = getActivity().findViewById(R.id.makenote);
        openexplored = getActivity().findViewById(R.id.openexplored);
        ...
        openexplored.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
